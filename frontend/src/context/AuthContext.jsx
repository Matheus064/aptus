...
export function AuthProvider({ children }) {
  ...
  const login = async (email, senha) => guardar(await requisicao('/auth/login', { method: 'POST', body: { email, senha } }));
  ...
  return <AuthContext.Provider value={{ ...sessao, login, registro, logout }}>{children}</AuthContext.Provider>;
}
