...
2. **Abra o Terminal MIntegrado do VS Code:**
...
- **João**
- **Augusto**
rk CSS utilitário para design responsivo e moderno.
- **JavaScript ES6+ (Vanilla)** — Lógica do cliente, manipulação do DOM e chamadas assíncronas via `fetch`.
...
- **João**
- **Augusto**
http://localhost:3000/api/healthhttp://localhost:3000/api/healthhttp://localhost:3000/api/health
